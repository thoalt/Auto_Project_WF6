...
class Test_RULE_FACTORY_DEVICENAME(softest.TestCase):
    ...
    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_01"))
    @unpack
    ...
    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_02"))
    @unpack
    def test_RULE_FACTORY_DEVICENAME_02(self, device_name, expectResult):
        self.hp.set_device_info(deviceName=device_name, clickAction=False)
        assert_that(expectResult).contains(self.hp.get_alert_info())

    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_03"))
    @unpack
    def test_RULE_FACTORY_DEVICENAME_03(self, device_name, expectResult):
        self.hp.set_device_info(deviceName=device_name, clickAction=False)
        assert_that(expectResult).contains(self.hp.get_alert_info())

    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_04"))
    @unpack
    def test_RULE_FACTORY_DEVICENAME_04(self, device_name, expectResult):
        self.hp.set_device_info(deviceName=device_name, clickAction=False)
        assert_that(expectResult).contains(self.hp.get_alert_info())

    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_05"))
    @unpack
    def test_RULE_FACTORY_DEVICENAME_05(self, device_name, expectResult):
        self.hp.set_device_info(deviceName=device_name, clickAction=False)
        assert_that(expectResult).contains(self.hp.get_alert_info())

    @data(*ExcelPaser.read_data_via_testcaseID(excel_sheet, "RULE_FACTORY_DEVICENAME_06"))
    @unpack
